...
const testimonials = [
  {
    text: "O Residente de Elite foi exatamente o que eu precisava na fase final da preparação: uma revisão completa, mas extremamente focada na prova da SES-PE, priorizando o que realmente cai e da forma como cai. Pela primeira vez, consegui verdadeiramente compreender conteúdos que sempre foram confusos e que eu apenas tentava decorar, como as classificações de cirurgia. O que antes me causava insegurança pelo medo de errar se transformou em clareza, graças aos professores incríveis, que ensinam com muita didática, sempre trazendo dicas e macetes que ajudam a lembrar dos assuntos, acertar as questões e não errar nos detalhes. Além da disponibilidade constante para discutir questões e tirar dúvidas.\n\nMas o MAIOR diferencial, sem dúvida, foi o feedback individualizado pós-simulado, algo que eu não esperava, pois já tendo os vídeos de correção, esse cuidado extra mostrou o quão grande é o compromisso de vocês com a nossa aprovação. Ter a oportunidade de discutir meus erros, entender onde ajustar, revisar e evoluir foi fundamental para minha aprovação. Não tenho dúvidas de que o Residente de Elite ainda vai crescer muitooooo. Indico demais!!!!",
